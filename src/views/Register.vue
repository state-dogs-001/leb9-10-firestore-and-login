<template>
  <v-container>
    <v-card style="margin-top: 40px; background-color: #E7E7E7">
      <v-container>
        <h1 style="margin-bottom: 20px; font-size: 60px; color: black">
          Register
          <v-icon size="60" color="black">mdi-account</v-icon>
        </h1>
